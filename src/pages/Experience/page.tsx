      ...
      <div className="@container mx-auto max-w-5xl px-6 relative">
        ...
        >
          <ExperienceCard
            ...
            description="Developed and maintained JavaScript libraries, improving framework performance and functionality."
            icon={<Code />}
          />
          ...
          <ExperienceCard
            ...
            company="Kgisl"
            period="2025 Mar - 2025 Aug"
            description="Built and optimized responsive, interactive user interfaces, ensuring smooth user experiences."
            icon={<Briefcase />}
          />
          ...
          <ExperienceCard
            ...
            description="Customized and developed WordPress websites for global clients, focusing on performance and usability."
            icon={<Briefcase />}
          />
